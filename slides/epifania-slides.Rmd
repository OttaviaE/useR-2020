...
$$D-score = \frac{M_{conditionA} - M_{conditionB}}{sd_{pooled}}$$

The steps that have to be undertaken to clean and prepare the data set for the computation make it an error prone procedure and raise replicability issues.
...
commonFunctions <- data.frame(Function = c("`descript_d()`", "`d_distr()`", 
                                           "`d_plot()`"), 
                              Description = c("Descriptive table of the *D-score*s (even in LaTeX format!)", "Plot of the results at the individual level", "Plot of the results at the sample level"))
